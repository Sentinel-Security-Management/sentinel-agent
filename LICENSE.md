...
Sentinel Agent is a host-based security and observability agent developed by The Deployment Lab.

The Licensed Work includes:

* Sentinel Agent source code
...
In addition to the rights granted under the Functional Source License:

You may:

* Use Sentinel Agent internally within your organization.
* Deploy Sentinel Agent in production environments you own or operate.
* Use Sentinel Agent for educational purposes.
* Use Sentinel Agent for research purposes.
* Modify Sentinel Agent for internal use.
...
The Deployment Lab, Sentinel, Sentinel Agent, associated logos, branding assets, and project marks are trademarks of The Deployment Lab.
